...
namespace Amadeus.Chromium.Tabs {
	[Register("TabContentsDelegate", true)]
	[Model]
	public unsafe abstract partial class TabContentsDelegate : NSObject {
		...
		[Export ("init")]
		public TabContentsDelegate () : base (NSObjectFlag.Empty)
		{
		...
		public TabContentsDelegate (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			IsDirectBinding = GetType ().Assembly == global::ChromiumTabsAPI.Messaging.this_assembly;
			if (IsDirectBinding) {
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public TabContentsDelegate (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ChromiumTabsAPI.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public TabContentsDelegate (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ChromiumTabsAPI.Messaging.this_assembly;
		}
